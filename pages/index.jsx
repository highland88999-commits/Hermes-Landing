...
// Dynamically import the Three.js canvas to prevent Next.js server-side rendering errors
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="The Grand Multiverse Directory for nexusvortex.ca" />
      </Head>
